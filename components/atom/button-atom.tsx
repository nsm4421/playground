...
export default function ButtonAtom(props: AtomProps) {
  ...
  switch (props.color) {
    ...
    default: // blue
      clsName =
      "text-white bg-blue-400 hover:bg-blue-500 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mr-2 mb-2 dark:focus:ring-blue-900";;
  }
  return (
    <button
