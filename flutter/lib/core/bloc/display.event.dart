...
/// 필요한 경우만 구현해도 되는 이벤트
final class UpdateDisplayDataEvent<T extends Entity> extends DisplayEvent {
  final List<T> data;

  UpdateDisplayDataEvent(this.data);
}

final class InsertDisplayDataEvent<T extends Entity> extends DisplayEvent {
  final List<T> data;

  InsertDisplayDataEvent(this.data);
}

final class DeleteDisplayDataEvent<T extends Entity> extends DisplayEvent {
  final T e; // 삭제할 entity

  DeleteDisplayDataEvent(this.e);
}
