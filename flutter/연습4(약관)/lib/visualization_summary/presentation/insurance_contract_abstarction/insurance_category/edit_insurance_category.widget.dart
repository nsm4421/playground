...
class EditInsuranceCategoryWidget extends StatefulWidget {
  const EditInsuranceCategoryWidget(this._initialInsuranceCategories, {super.key});

  final List<String> _initialInsuranceCategories;
...
class _EditInsuranceCategoryWidgetState
  ...
  void initState() {
    ...
    _insuranceCategories = widget._initialInsuranceCategories;
